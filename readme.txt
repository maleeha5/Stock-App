...
A basic stock web app, built with the help of streamlit library where one can check through the stocks of the companies within a stipulated range of time

To view the result , select the start date, end date and the action for which you'd like to view the line_charts
